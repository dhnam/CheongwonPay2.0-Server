...
class User extends Thread {
	...
	public static final int OP_LOGIN = 1, OP_PURCHASE = 2, OP_ADD_ITEM = 3, OP_RF_BAL = 4, OP_GET_GOODS_LIST = 5,
			...
			OP_GET_NAME = 14, OP_USER_MATCHING = 15, OP_CHARGE = 16, OP_PURCHASE_RS_NOTIME = 103, OP_PURCHASE_RS_OVERLIMIT = 104,
			OP_PURCHASE_RS_USERNULL = 106, OP_PURCHASE_RS_SUCCESS = 105, OP_CHARGE_RS_USERNULL = 107, OP_CHARGE_RS_SUCCESS = 108, OP_EXIT = 1110;// 통신시 이용하는 명령 코드(OP-Code)를 정수
																							// 데이터타입으로 저장한다.
